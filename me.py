...
#cl = LineClient(authToken="udddd008aef6d454ee4a96c2ea98444c0:aWF0OiAxNTQ3MTI4NzI2ODQ1Cg==..A2crs6Rh8Q7nL+ehB7HBNh7CibA=")
cl = LineClient(authToken='u3f01617eaf3ac162e8fd4238215b7f01:aWF0OiAxNTQ3MzYzMTU3MDU4Cg==..fJIwBop2VfsfDzLT1OQogqwopXw=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='u1855c565f7e67be440174370efaca50a:aWF0OiAxNTQ3MTI4MTg4NDczCg==..iQCH8LX8uwOwYn09gQ+JQNAJAjk=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='u0b1da55e8fa56c11593bf5e0209ae202:aWF0OiAxNTQ3MDYxMTE3OTYwCg==../e+RiiAwEpw+LbDHAXQkHh5EvkI=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='u537098206fd4f994cc6231b7fe25de3e:aWF0OiAxNTQ3MDU4MjUzMTY3Cg==..MrSF4GowaliY2UfFJSVZyITusjI=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#km = LineClient()
km = LineClient(authToken='u8886c75ad7f161bbccfe97848294d6c8:aWF0OiAxNTQ3MDU2MTI4NzM3Cg==..vRJr5TRarJtSG/31q+N6qRZSQYQ=')
...
#TALKBAN
                 if msg._from in admin:
                  if Setmain["Talkwblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        cl.sendMessage(msg.to,"Contact itu sudah ada di Talkban")
                        Setmain["Talkwblacklist"] = True
                    else:
                        Setmain["Talkblacklist"][msg.contentMetadata["mid"]] = True
                        Setmain["Talkwblacklist"] = True
	#		f = codecs.open("setting.json","w","utf-8")
	#		json.dump(Setmain, f, sort_keys=True, indent=4,ensure_ascii=False)
                        cl.sendMessage(msg.to,"Berhasil menambahkan ke Talkban user")
                  if Setting["Talkdblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        del Setmain["Talkblacklist"][msg.contentMetadata["mid"]]
	#		f = codecs.open("setting.json","w","utf-8")
	#		json.dump(Setmain, f, sort_keys=True, indent=4,ensure_ascii=False)
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              Setmain["blacklist"] = {}
                              ragets = cl.getContacts(Setmain["blacklist"])
