...
cl = LineClient(authToken="u6ab2828ff1a0621ecf4574e4ceaaeb6d:aWF0OiAxNTQ2NjYxNzA5NDE1Cg==..QB+ITQj3O1OqelHWBTxK1iJA5G4=")
#cl = LineClient(authToken='u1855c565f7e67be440174370efaca50a:aWF0OiAxNTQ3MTI4MTg4NDczCg==..iQCH8LX8uwOwYn09gQ+JQNAJAjk=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='u0b1da55e8fa56c11593bf5e0209ae202:aWF0OiAxNTQ3MDYxMTE3OTYwCg==../e+RiiAwEpw+LbDHAXQkHh5EvkI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='u537098206fd4f994cc6231b7fe25de3e:aWF0OiAxNTQ3MDU4MjUzMTY3Cg==..MrSF4GowaliY2UfFJSVZyITusjI=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='u8886c75ad7f161bbccfe97848294d6c8:aWF0OiAxNTQ3MDU2MTI4NzM3Cg==..vRJr5TRarJtSG/31q+N6qRZSQYQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#km = LineClient()
km = LineClient(authToken='ufefb1f56bf997330bc24fb0f6e96f951:aWF0OiAxNTQ3MzY0MTAwMjk5Cg==..mbRgT7MoSpsYOzKHwuf7IKYu4PM=')
km.log("Auth Token : " + str(km.authToken))
channel3 = LineChannel(kc)
km.log("Channel Access Token : " + str(channel3.channelAccessToken))

#kn = LineClient()
kn = LineClient(authToken='u3f01617eaf3ac162e8fd4238215b7f01:aWF0OiAxNTQ3MzYzMTU3MDU4Cg==..fJIwBop2VfsfDzLT1OQogqwopXw=')
...
poll = LinePoll(cl)
call = cl
creator = ["u6723125e7f53d6758acb4aaa613605d0"]
        ...
        if op.type == 13:
            ...
            if op.param3 in wait["blacklist"]:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    wait["blacklist"][op.param2] = True
                    try:
                        random.choice(ABC).csncelGroupInvitation(op.param1,[op.param3])
                        random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                    except:
                        pass
        ...
        if op.type == 19:
            ...
            if Bmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        random.choice(ABC).kickoutFromGroup(op.param1,[op.param2]) 
                        random.choice(ABC).inviteIntroGroup(op.param1,[op.param3]) 
                        kk.acceptGroupInvitation(op.param1)
                        wait["blacklist"][op.param2] = True
                    except:
                        try:
